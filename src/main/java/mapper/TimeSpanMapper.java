...
public class TimeSpanMapper {
    ...
    private static ColumnFamily<Integer, String> TIMESPAN_CF;
    private final AstyanaxContext<Keyspace> context;
    private final Keyspace keyspace;
    static final String TIMESPAN_CF_NAME = "timespan";
    static final String COL_NAME_TIMESPAN = "timespan";


    private static final String INSERT_STATEMENT =
            String.format("INSERT INTO %s (%s, %s, %s, %s) VALUES (?, ?, ?, dateof(now()));",
                    TIMESPAN_CF_NAME, COL_NAME_USER_ID, COL_NAME_SKU_ID, COL_NAME_TIMESPAN, COL_NAME_ADD_TIME);

    public TimeSpanMapper() {
        ...
        TIMESPAN_CF = ColumnFamily.newColumnFamily(
                TIMESPAN_CF_NAME,
